  ...
  return (
    <main className="flex flex-1">
      <div className="lg:w-[40%] w-full flex flex-col justify-between px-12 py-10">
        <div className="flex-1 flex items-center justify-center">
          <div className="">
            <h1 className="text-2xl text-white md:text-3xl mb-6">
              Hi! I can help narrow down {equipment?.name} options for you
              without selling to you :)
            </h1>
            <p className="text-[#4aa6a4] text-2xl mb-8">
        ...
        <div className="text-sm text-[#FFFFFF]/41 text-center">
