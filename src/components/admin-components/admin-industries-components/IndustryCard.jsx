    ...
    <div className="bg-[#1a1e24] rounded-lg border border-[#2a2e34] overflow-hidden group">
      <div className="relative h-48">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
          <button onClick={() => handleEdit(industry)} className="p-2 bg-[#3CBFAE] rounded-md hover:bg-[#35a99a] transition-colors">
            <Pencil size={18} className="text-white" />
          </button>
          <button onClick={() => handleDelete(industry)} className="p-2 bg-red-500 rounded-md hover:bg-red-600 transition-colors">
