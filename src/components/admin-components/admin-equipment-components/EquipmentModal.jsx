          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={onFormChange}
                className={`w-full rounded-md bg-[#0f1216] border ${
                  errors.maxProducts ? "border-red-500" : "border-[#2a2e34]"
                } px-3 py-2 text-white focus:outline-none focus:border-[#3CBFAE] cursor-text`}
            ...
            <div className="flex items-center gap-2 mt-4">
              <input
                ...
                onChange={(e) =>
                  onFormChange({
                    target: { name: "visibility", value: e.target.checked },
                  })
                }
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-[#3CBFAE] hover:bg-[#35a99a] text-white rounded-md cursor-pointer"
              >
